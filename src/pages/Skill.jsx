    ...
    return (
        <section id="skill_box" className="p-5 lg:p-10 bg-white">
            <div className="skill-container mx-auto max-w-4xl">
                <div className="text-left mb-2 mt-12">
                ...
                <div className="flex flex-wrap justify-start gap-4">
                    <div className="w-full">
                        <h3 className="text-xl text-left lg:text-2xl font-semibold mb-5 mt-5">Frameworks</h3>
                    ...
                    <div className="w-full mb-5">
                        <h3 className="text-xl text-left lg:text-2xl font-semibold mb-5 mt-5">Language</h3>
                        <ul className="flex flex-wrap justify-start gap-4">
                    ...
                    <div className="w-full mb-5">
                        <h3 className="text-xl text-left lg:text-2xl font-semibold mb-5">Libraries</h3>
                        <ul className="flex flex-wrap justify-start gap-4">
                    ...
                    <div className="w-full mb-5">
                        <h3 className="text-xl text-left lg:text-2xl font-semibold mb-5">Design</h3>
                        <ul className="flex flex-wrap justify-start gap-4">
                            <li className="flex items-center rounded-lg border shadow-lg py-3 px-3 transition-transform duration-600"><img src="/img/figma.png" alt="Figma 아이콘" className="w-12 mr-5"/>Figma</li>
                        </ul>
                    </div>

                    <div className="w-full mb-5">
                        <h3 className="text-xl text-left lg:text-2xl font-semibold mb-5">Collaboration</h3>
                        <ul className="flex flex-wrap justify-start gap-4">
